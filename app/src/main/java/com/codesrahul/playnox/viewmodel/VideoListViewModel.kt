...
import com.codesrahul.playnox.domain.model.StorageVolumeInfo
...
import com.codesrahul.playnox.domain.model.WatchHistory
import com.codesrahul.playnox.util.getAvailableStorageVolumes
...
import com.codesrahul.playnox.ui.screens.videolist.state.PathSegment
...
class VideoListViewModel(
                    ...
                    val videos = items.map { item ->
                        ...
                        if (item.size > 0 && item.duration > 0) {
                            ...
                            if (cached != null) {
                                ...
                                val extracted = com.codesrahul.playnox.util.getVideoMetadata(repository.context, item.uri)
                                ...
                                metadataDao.insertOrUpdate(
                                    com.codesrahul.playnox.data.database.CachedVideoMetadata(
                                        uri = uriStr,
                                        size = finalSize,
    ...
    fun selectFolder(folder: VideoFolder?) {
        ...
        if (folder != null) {
            ...
            com.codesrahul.playnox.domain.thumbnail.ThumbnailRepository.getInstance(repository.context)
