...
import com.codesrahul.playnox.data.model.FolderItem
import com.codesrahul.playnox.data.model.VideoItem
...
class VideoRepository(
    ...
    val videoMetadataDao = com.codesrahul.playnox.data.database.AppDatabase.getDatabase(context).videoMetadataDao()
        ...
        trashedItems.map { item ->
            ...
            if (item.size > 0 && item.duration > 0) {
                ...
                if (cached != null) {
                    ...
                    val extracted = com.codesrahul.playnox.util.getVideoMetadata(context, item.uri)
