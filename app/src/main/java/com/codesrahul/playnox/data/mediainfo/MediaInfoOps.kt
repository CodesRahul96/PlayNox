package com.codesrahul.playnox.data.mediainfo
          ...
          runCatching {
              ...
              try {
                  ...
                  buildString {
                      ...
                      appendLine()
                      appendLine("=".repeat(60))
                      appendLine("Generated by PlayNox Player using MediaInfoLib")
                      appendLine("=".repeat(60))
                  }
              } finally {
                  mi.Close()
              ...
              try {
                  ...
                  buildString {
                      ...
                      appendLine()
                      appendLine("=".repeat(60))
                      appendLine("Generated by PlayNox Player (JNI Unavailable)")
                      appendLine("=".repeat(60))
                  }
              } finally {
                  retriever.release()
