package com.codesrahul.playnox.player.service
...
import com.codesrahul.playnox.MainActivity
...
class MediaPlaybackService : Service() {
    ...
    private val receiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            when (intent?.action) {
                ...
                ACTION_PREV -> {
                    val broadcastIntent = Intent("com.codesrahul.playnox.PIP_PREV").apply {
                        setPackage(packageName)
                    }
                    sendBroadcast(broadcastIntent)
                }
                ACTION_NEXT -> {
                    val broadcastIntent = Intent("com.codesrahul.playnox.PIP_NEXT").apply {
                        setPackage(packageName)
                    }
                    sendBroadcast(broadcastIntent)
                }
    ...
    companion object {
        ...
        const val ACTION_TOGGLE_PLAYBACK = "com.codesrahul.playnox.ACTION_TOGGLE_PLAYBACK"
        const val ACTION_STOP = "com.codesrahul.playnox.ACTION_STOP"
        const val ACTION_PREV = "com.codesrahul.playnox.ACTION_PREV"
        const val ACTION_NEXT = "com.codesrahul.playnox.ACTION_NEXT"
        const val ACTION_REWIND = "com.codesrahul.playnox.ACTION_REWIND"
        const val ACTION_FORWARD = "com.codesrahul.playnox.ACTION_FORWARD"
    ...
    private fun updateNotification() {
        ...
        val metadataBuilder = MediaMetadataCompat.Builder()
            ...
            .putString(MediaMetadataCompat.METADATA_KEY_ARTIST, "PlayNox Player")
