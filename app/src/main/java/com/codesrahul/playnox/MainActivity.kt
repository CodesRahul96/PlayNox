package com.codesrahul.playnox
...
import com.codesrahul.playnox.data.media.MediaStoreHelper
...
class MainActivity : ComponentActivity() {
    ...
    private val pipReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            ...
            when (intent.action) {
                "com.codesrahul.playnox.PIP_PREV" -> playerViewModel.playPrevious()
                "com.codesrahul.playnox.PIP_PLAY_PAUSE" -> {
                    playerViewModel.togglePlayback()
                    updatePipActions()
                }
                "com.codesrahul.playnox.PIP_NEXT" -> playerViewModel.playNext()
            }
        }
    }
    ...
    private fun buildPipActionsList(): List<android.app.RemoteAction> {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            // 1. Prev Action
            val prevIntent = Intent("com.codesrahul.playnox.PIP_PREV")
            ...
            val playPauseIntent = Intent("com.codesrahul.playnox.PIP_PLAY_PAUSE")
            ...
            // 3. Next Action
            val nextIntent = Intent("com.codesrahul.playnox.PIP_NEXT")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            try {
                com.codesrahul.playnox.player.ytdlp.YtdlpManager.copyAssets(applicationContext)
        ...
        val filter = IntentFilter().apply {
            addAction("com.codesrahul.playnox.PIP_PREV")
            addAction("com.codesrahul.playnox.PIP_PLAY_PAUSE")
            addAction("com.codesrahul.playnox.PIP_NEXT")
        }
    ...
    private fun logExternalVideoHistory(uri: Uri) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            try {
                ...
                val metadataResult = com.codesrahul.playnox.data.mediainfo.MediaInfoOps.extractBasicMetadata(
                    this@MainActivity,
                    uri,
                    fileName
                )
                ...
                val video = com.codesrahul.playnox.domain.model.Video(
                    uri = uri.toString(),
                    title = fileName,
                    duration = duration,
                    folderName = "",
